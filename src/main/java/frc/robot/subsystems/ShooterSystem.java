...
public class ShooterSystem extends SubsystemBase {
  ...
  public boolean mayShoot() {
    return topWheel.getEncoder(EncoderType.kQuadrature, 8092).getVelocity() > .95 * Constants.shooterSpeed && bottomWheel.getEncoder(EncoderType.kQuadrature, 8092).getVelocity() > .95 * Constants.shooterSpeed;
  }
}
